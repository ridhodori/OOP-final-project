...
public class Board extends JComponent {
    ...
    //Draw the current piece locations to the board
    private void drawBoard()
    {
        ...
        if (Active_Piece != null) //When a player clicks on a piece
        {
    ...
    private MouseAdapter mouseAdapter = new MouseAdapter() {
        ...
        public void mousePressed(MouseEvent e) {
            ...
            if (Active_Piece == null && clicked_piece != null && 
                ((is_whites_turn && clicked_piece.isWhite()) || (!is_whites_turn && clicked_piece.isBlack()))){ //Make sure player can only click their turn
                Active_Piece = clicked_piece;
            }
            else if (Active_Piece != null && Active_Piece == clicked_piece) //If a player un-clicks a piece
            {
                Active_Piece = null;
            }
                ...
                if (Active_Piece.getClass().equals(Pawn.class)) //Make sure each pawn can only move 2 cells if hadn't move
                {
